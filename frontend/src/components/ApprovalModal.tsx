...
export function ApprovalModal({ approvals, onDecide, busy }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-lg bg-neutral-900 border border-neutral-800 shadow-2xl">
        ...
        <div className="px-5 py-4 space-y-4 max-h-[60vh] overflow-y-auto">
          {approvals.map((a) => (
            ...
            >
              ...
              <pre className="bg-neutral-900 text-emerald-200 rounded p-2 text-xs overflow-x-auto whitespace-pre-wrap break-words">
        ...
        <div className="px-5 py-3 border-t border-neutral-800">
          <input
            ...
            className="w-full rounded bg-neutral-950 border border-neutral-800 px-3 py-2 text-sm focus:outline-none focus:border-neutral-600"
          />
        </div>
      </div>
    </div>
